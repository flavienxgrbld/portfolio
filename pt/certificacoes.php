<?php
    $pageTitle = 'Certificações - Flavien GARIBALDI';
    $currentPage = 'certificacoes.php';
    include '../includes/header.php';
?>

    <section id="certifications" style="margin-top: 100px;">
        <h2 class="fade-up">As Minhas Certificações</h2>
        <p style="color: var(--text-gray); font-size: 1.1rem; margin-bottom: 3rem; text-align: center;">
            Encontre aqui o conjunto das minhas certificações profissionais e formações realizadas.<br>
            Estas certificações atestam as minhas competências e o meu compromisso com a melhoria contínua.
        </p>

        <h3 style="color: var(--text-light); margin-bottom: 2rem; font-size: 1.8rem;">
            <i class="fas fa-certificate" style="color: var(--primary-color);"></i> Certificações Obtidas
        </h3>
        ...
        <div class="projects-grid">
            <div class="project-card">
                ...
                <div class="project-info">
                    <h3>MOOC Cibersegurança - ANSSI</h3>
                    <p style="color: var(--primary-color); margin: 0.5rem 0; font-weight: 600;">SecNumacadémie</p>
                    <p>Formação de sensibilização para a cibersegurança proposta pela Agência Nacional de Segurança dos Sistemas de Informação.</p>
                    ...
                    <p style="font-size: 0.9rem; color: var(--text-gray);">
                        <i class="fas fa-calendar-alt"></i> Obtida em: 2024
                    </p>
                </div>
            </div>
        </div>
        ...
        <h3 style="color: var(--text-light); margin-top: 4rem; margin-bottom: 2rem; font-size: 1.8rem;">
            <i class="fas fa-book-reader" style="color: var(--secondary-color);"></i> Em preparação
        </h3>
        ...
        <div class="projects-grid">
            <div class="project-card" style="border: 2px solid var(--secondary-color);">
                ...
                <div class="project-info">
                    ...
                    <p>Certificação de rede Cisco que cobre os fundamentos de redes, encaminhamento, comutação e segurança.</p>
                    <div class="skills" style="margin-top: 1rem; margin-bottom: 1rem;">
                    ...
                    <p style="font-size: 0.9rem; color: var(--text-gray);">
                        <i class="fas fa-hourglass-half"></i> Em preparação
                    </p>
                </div>
            </div>
            ...
            <div class="project-card" style="border: 2px solid var(--secondary-color);">
                ...
                <div class="project-info">
                    ...
                    <p>Certificação de base Cisco que valida as competências em suporte de rede e resolução de problemas.</p>
                    <div class="skills" style="margin-top: 1rem; margin-bottom: 1rem;">
                        <span class="skill-tag">Cisco</span>
            ...
            <div class="project-card" style="border: 2px solid var(--secondary-color);">
                ...
                <div class="project-info">
                    ...
                    <p>Certificação Cisco de base em cibersegurança que cobre os conceitos essenciais de segurança.</p>
                    <div class="skills" style="margin-top: 1rem; margin-bottom: 1rem;">
                        <span class="skill-tag">Cybersécurité</span>
                        <span class="skill-tag">Cisco</span>
            ...
            <div class="project-card" style="border: 2px solid var(--secondary-color);">
                ...
                <div class="project-info">
                    ...
                    <p>Certificação Cisco sobre a segurança de endpoints e proteção de postos de trabalho.</p>
                    <div class="skills" style="margin-top: 1rem; margin-bottom: 1rem;">
