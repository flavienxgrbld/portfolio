<?php
    $pageTitle = 'Certyfikaty - Flavien GARIBALDI';
    $currentPage = 'certyfikaty.php';
    include '../includes/header.php';
?>

    <section id="certifications" style="margin-top: 100px;">
        <h2 class="fade-up">Moje Certyfikaty</h2>
        <p style="color: var(--text-gray); font-size: 1.1rem; margin-bottom: 3rem; text-align: center;">
            Znajdź tutaj wszystkie moje profesjonalne certyfikaty i ukończone szkolenia.<br>
            Te certyfikaty poświadczają moje kompetencje i zaangażowanie w ciągły rozwój.
        </p>

        <h3 style="color: var(--text-light); margin-bottom: 2rem; font-size: 1.8rem;">
            <i class="fas fa-certificate" style="color: var(--primary-color);"></i> Uzyskane Certyfikaty
        </h3>
        ...
        <div class="projects-grid">
            <div class="project-card">
                ...
                <div class="project-info">
                    <h3>MOOC Cyberbezpieczeństwo - ANSSI</h3>
                    <p style="color: var(--primary-color); margin: 0.5rem 0; font-weight: 600;">SecNumacadémie</p>
                    <p>Szkolenie uświadamiające w zakresie cyberbezpieczeństwa oferowane przez Narodową Agencję Bezpieczeństwa Systemów Informatycznych.</p>
                    ...
                    <p style="font-size: 0.9rem; color: var(--text-gray);">
                        <i class="fas fa-calendar-alt"></i> Uzyskano w: 2024
                    </p>
                </div>
            </div>
        </div>
        ...
        <h3 style="color: var(--text-light); margin-top: 4rem; margin-bottom: 2rem; font-size: 1.8rem;">
            <i class="fas fa-book-reader" style="color: var(--secondary-color);"></i> W trakcie przygotowania
        </h3>
        ...
        <div class="projects-grid">
            <div class="project-card" style="border: 2px solid var(--secondary-color);">
                ...
                <div class="project-info">
                    ...
                    <p>Certyfikat sieciowy Cisco obejmujący podstawy sieci, routing, przełączanie i bezpieczeństwo.</p>
                    <div class="skills" style="margin-top: 1rem; margin-bottom: 1rem;">
                    ...
                    <p style="font-size: 0.9rem; color: var(--text-gray);">
                        <i class="fas fa-hourglass-half"></i> W przygotowaniu
                    </p>
                </div>
            </div>
            ...
            <div class="project-card" style="border: 2px solid var(--secondary-color);">
                ...
                <div class="project-info">
                    ...
                    <p>Podstawowy certyfikat Cisco potwierdzający kompetencje w zakresie wsparcia sieciowego i rozwiązywania problemów.</p>
                    <div class="skills" style="margin-top: 1rem; margin-bottom: 1rem;">
                        <span class="skill-tag">Cisco</span>
            ...
            <div class="project-card" style="border: 2px solid var(--secondary-color);">
                ...
                <div class="project-info">
                    ...
                    <p>Podstawowy certyfikat Cisco w zakresie cyberbezpieczeństwa obejmujący podstawowe koncepcje bezpieczeństwa.</p>
                    <div class="skills" style="margin-top: 1rem; margin-bottom: 1rem;">
                        <span class="skill-tag">Cybersécurité</span>
                        <span class="skill-tag">Cisco</span>
            ...
            <div class="project-card" style="border: 2px solid var(--secondary-color);">
                ...
                <div class="project-info">
                    ...
                    <p>Certyfikat Cisco dotyczący bezpieczeństwa punktów końcowych i ochrony stacji roboczych.</p>
                    <div class="skills" style="margin-top: 1rem; margin-bottom: 1rem;">
