...
?>
    ...
    <section id="certifications" style="margin-top: 100px;">
        <h2 class="fade-up">Minhas Certificações</h2>
        <p style="color: var(--text-gray); font-size: 1.1rem; margin-bottom: 3rem; text-align: center;">
            Aqui você encontra todas as minhas certificações profissionais e treinamentos concluídos.<br>
            Essas certificações atestam minhas competências e meu compromisso com a melhoria contínua.
        </p>
        ...
        <div class="projects-grid">
            <div class="project-card">
                ...
                <div class="project-info">
                    ...
                    <p>Treinamento de conscientização em cibersegurança oferecido pela Agência Nacional de Segurança dos Sistemas de Informação.</p>
        ...
        <div class="projects-grid">
            <div class="project-card" style="border: 2px solid var(--secondary-color);">
                ...
                <div class="project-info">
                    ...
                    <p>Certificação de rede Cisco que cobre os fundamentos de redes, roteamento, comutação e segurança.</p>
                    <div class="skills" style="margin-top: 1rem; margin-bottom: 1rem;">
            ...
            <div class="project-card" style="border: 2px solid var(--secondary-color);">
                ...
                <div class="project-info">
                    ...
                    <p>Certificação básica da Cisco que valida competências em suporte de rede e solução de problemas.</p>
                    <div class="skills" style="margin-top: 1rem; margin-bottom: 1rem;">
                        <span class="skill-tag">Cisco</span>
            ...
            <div class="project-card" style="border: 2px solid var(--secondary-color);">
                ...
                <div class="project-info">
                    ...
                    <p>Certificação básica da Cisco em cibersegurança cobrindo conceitos essenciais de segurança.</p>
                    <div class="skills" style="margin-top: 1rem; margin-bottom: 1rem;">
                        <span class="skill-tag">Cybersécurité</span>
                        <span class="skill-tag">Cisco</span>
            ...
            <div class="project-card" style="border: 2px solid var(--secondary-color);">
                ...
                <div class="project-info">
                    ...
                    <p>Certificação Cisco sobre segurança de endpoints e proteção de estações de trabalho.</p>
                    <div class="skills" style="margin-top: 1rem; margin-bottom: 1rem;">
