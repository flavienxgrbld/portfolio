        ...
        <div class="projects-grid">
            <div class="project-card">
                ...
                <div class="project-info">
                    ...
                    <p>Implementação de uma infraestrutura de rede completa com VLAN, roteamento inter-VLAN e servidor DHCP para uma empresa fictícia.</p>
                    <div class="skills">
            ...
            <div class="project-card">
                ...
                <div class="project-info">
                    ...
                    <p>Sistema de backup automatizado com estratégia de restauração para garantir a continuidade do serviço.</p>
                    <div class="skills">
            ...
            <div class="project-card">
                ...
                <div class="project-info">
                    ...
                    <p>Implantação de um ambiente virtualizado com gerenciamento de máquinas virtuais e alocação de recursos.</p>
                    <div class="skills">
            ...
            <div class="project-card">
                ...
                <div class="project-info">
                    ...
                    <p>Criação deste portfólio para apresentar minhas habilidades, projetos e monitoramento tecnológico.</p>
                    <div class="skills">
