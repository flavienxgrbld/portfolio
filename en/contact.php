...
?>
    ...
    <section id="contact" style="margin-top: 100px;">
        ...
        <p style="color: var(--text-gray); font-size: 1.1rem; margin-bottom: 3rem; text-align: center;">
            Do you have a question, a project or just want to chat?<br>
            ...
            <form method="POST" action="contact.php">
                <div class="form-row">
                    <div class="form-group">
                        <label for="nom"><i class="fas fa-user"></i> Full name *</label>
                        <input type="text" id="nom" name="nom" required placeholder="Your name" value="<?php echo isset($nom) ? $nom : ''; ?>">
                    </div>
                ...
                <div class="form-group">
                    <label for="sujet"><i class="fas fa-tag"></i> Subject *</label>
                    <input type="text" id="sujet" name="sujet" required placeholder="The subject of your message" value="<?php echo isset($sujet) ? $sujet : ''; ?>">
                </div>

                <div class="form-group">
                    <label for="message"><i class="fas fa-comment"></i> Message *</label>
                    <textarea id="message" name="message" required placeholder="Your message..."><?php echo isset($message) && !$message_sent ? $message : ''; ?></textarea>
                </div>
        ...
        <div style="margin-top: 4rem; text-align: center;">
            <h3 style="margin-bottom: 1.5rem; color: var(--text-light);">Find me also on</h3>
